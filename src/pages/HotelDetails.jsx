...
const HotelDetails = () => {
   ...
   const { photo, title, desc, price, city, address, distance, maxGroupSize } = hotel
   // const {hotelname,price, city, address, distance, maxGroupSize } = hotel
   // const {title,price, city, address } = hotel
