...
function BookingListRow1(props) {
    const { _id, hotelName, bookAt, fullName, phone, guestSize} = props.obj;
    const handleEdit = () => {
        // Navigate to the edit page with the booking ID
        props.navigate(`/edit-hotel-booking/${_id}`);
      };
...
export default BookingListRow1;
